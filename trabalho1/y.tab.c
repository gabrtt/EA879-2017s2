...
static const char *const yytname[] =
{
  ...
  "EOL", "ASPA", "OPE", "NUM", "SOMA", "$accept", "PROGRAMA", "EXPRESSAO", YY_NULLPTR
};
#endif
...
#line 37 "./src/imageprocessing.y" /* yacc.c:1646  */
    {  
        ...
        printf("Li imagem %d por %d\n", I.width, I.height);
        printf("Aplicando %.2f em %s\n", (yyvsp[0].valor), (yyvsp[-2].strval));
        brilho(&I, (yyvsp[0].valor), (yyvsp[-1].ival));
...
#line 51 "./src/imageprocessing.y" /* yacc.c:1906  */
